import { getTeemsById } from "@/helpers/teem/get";
...
// };
const MisEquiposPage = async ({ params }: { params: { id: string } }) => {
  const teems = await getTeemsById(params.id);
  console.log("Estos son los eqipos🍀🤞🏽😎", teems);
  return (
    <div className="">
